  ...
  return (
    <div style={{
      ...
      <AnimatePresence>
        {startOpen && (
          <motion.div
            ...
            style={{
              position: 'absolute', bottom: 32, left: 0, width: 280,
              background: '#050508', border: '1px solid #ff2020', borderRadius: '4px 4px 0 0',
          ...
          >
            ...
            <div style={{ background: '#0a0a12', borderTop: '1px solid rgba(255,32,32,0.2)', padding: 8, display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
               <button onClick={() => window.location.reload()} style={{ background: 'transparent', border: '1px solid #ff2020', color: '#ff2020', padding: '4px 12px', fontSize: 9, borderRadius: 2, fontFamily: 'var(--share)', cursor: 'pointer' }}>LOG OFF</button>
               <button onClick={() => window.location.reload()} style={{ background: '#ff2020', border: '1px solid #ff2020', color: '#fff', padding: '4px 12px', fontSize: 9, borderRadius: 2, fontFamily: 'var(--share)', cursor: 'pointer' }}>TERMINATE</button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div style={{
        ...
        color: '#ff2020', fontSize: 10, fontFamily: 'var(--share)', letterSpacing: '1px'
      }}>
        <div style={{ opacity: 0.6, fontSize: 8 }}>UPLINK: ACTIVE</div>
